...
@WebServlet(name = "InstrumentoServletTabla", value = "/instrumento-servlet-tabla")
public class InstrumentoServletTabla extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        if (request.getSession().getAttribute("listaInstrumentos") == null) {
            ...
            try {
                ...
                request.getRequestDispatcher("jspTable.jsp").forward(request, response);
            } catch (SQLException e) {
                throw new RuntimeException(e);
            } finally {
                try {
